...
(cl:defmethod cl:initialize-instance :after ((m <MPerson>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MPerson)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name DEMO-msg:<MPerson> is deprecated: use DEMO-msg:MPerson instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <MPerson>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader DEMO-msg:name-val is deprecated.  Use DEMO-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <MPerson>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader DEMO-msg:age-val is deprecated.  Use DEMO-msg:age instead.")
  (age m))
